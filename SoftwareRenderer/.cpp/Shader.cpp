...
void PhongShader::VertexShader(Vertex& v_0,Vertex &v_1,Vertex &v_2)
{
	...
	//this->phong_vertex.vert_v0.Normal.Print();
	//this->phong_vertex.vert_v1.Normal.Print();
	//this->phong_vertex.vert_v2.Normal.Print();
	...
	for (int i = 0; i < 3; i++)
	{
		...
		case 0:
			...
			//this->phong_vertex.lightPos0.Print();
			...
			//this->phong_vertex.Light_View.Print();
			//this->phong_vertex.lightPos0.Print();
			...
			//this->phong_vertex.Light_Ortho.Print();
			//this->phong_vertex.lightPos0.Print();
			//v_0.Position.Print();
			//cout << "01-------------------------------------------" << endl;
			break;
		case 1:
		   ...
		   // this->phong_vertex.lightPos1.Print();
			//system("pause");
			//v_1.Position.Print();
			//cout << "02-------------------------------------------" << endl;
			break;
		case 2:
		    ...
		    //this->phong_vertex.lightPos2.Print();
			//v_2.Position.Print();
			//cout << "03-------------------------------------------" << endl;
			break;
		}
		...
		////问题出在着色上
		//cout << shadingPoint->v_Color.r << "  " << shadingPoint->v_Color.g << "  " << shadingPoint->v_Color.b << endl;
		//system("pause");
...
bool PhongShader::FragmentShader(Vertex &v,Vector3f G)
{
	...
	//this->phong_vertex.v_directionlight[0].GetInverstDirection().Normalize().Print();
	//cout << "---------------------------------" << endl;
	costheta = abs(this->phong_vertex.v_directionlight[0].GetInverstDirection().Normalize().Dot(Normal.Normalize()));
	//偏移因子
	//cout << Scale << endl;
	//cout << costheta << endl;
	//cout << this->phong_vertex.v_directionlight.size() << endl;
	...
	//cout << v.v_Color.r << "  " << v.v_Color.g << "  " << v.v_Color.b << "  " << v.v_Color.a << endl;
