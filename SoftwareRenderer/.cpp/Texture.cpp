...
void Texture::LoadTexture(const wchar_t* path)       //加载材质
{
	...
	//	for (int j = 0; j < this->T_Height; j++)
	//	{
	//		cout << this->TextureData[i][j].r << "  ";
	//		cout << this->TextureData[i][j].g << "  ";
	//		cout << this->TextureData[i][j].b << "  ";
	//		cout << this->TextureData[i][j].a << endl;
	//	}
	//	
	//}
}
...
Color Texture::T_Sample(float u,float v)
{
	...
	//std::cout << Tex_u << std::endl;
	//std::cout << Tex_v << std::endl;
	//cout << this->T_Width << endl;
	//cout << this->T_Height << endl;
	//for (int i = 0; i < 10; i++)
	//{
	//	for (int j = 0; j < 10; j++)
	//	{
